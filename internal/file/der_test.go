...
func Test_parseDERData(t *testing.T) {
	testCases := []struct {
		...
		{fileContents("x509/der/dsa-1024.key"), Info{
		...
		{fileContents("x509/der/dsa-1024.pub"), Info{
		...
		{fileContents("x509/der/dsa-1024-dsa.key"), Info{
			Description: "DSA private key",
			Attributes: []Attribute{
				{Name: "Algorithm", Value: "DSA"},
				{Name: "Size", Value: "1024 bits"},
		...
		{fileContents("x509/der/rsa-512.key"), Info{
		...
		{fileContents("x509/der/rsa-512-pkcs1.key"), Info{
		...
		{fileContents("x509/der/rsa-512.pub"), Info{
			Description: "PKIX public key",
			Attributes: []Attribute{
				{Name: "Algorithm", Value: "RSA"},
				{Name: "Size", Value: "512 bits"},
		...
		{fileContents("x509/der/rsa-512-pkcs1.pub"), Info{
		...
		{fileContents("x509/der/prime256v1.key"), Info{
			Description: "PKCS#8 private key",
			Attributes: []Attribute{
		...
		{fileContents("x509/der/ed25519.pub"), Info{
			Description: "PKIX public key",
			Attributes: []Attribute{
				{Name: "Algorithm", Value: "EdDSA"},
				{Name: "Curve", Value: "Ed25519"},
		...
		{fileContents("x509/der/github.com.cer"), Info{
